    ...
    <script !src="">
        ...
        $(document).ready(function(){
            ...
            $(document).on("click", ".btn-edit", function () {
                var id = $(this).val();
                $.ajax({
                    url: "{{url('manager/payment/type')}}/" + id + "/edit",
                    headers: {
                        'X-CSRF-TOKEN': token
                    },
            ...
            $(document).on("click", "#submit", function () {
                ...
                if (type === 'Update') {
                    $.ajax({
                        type: "PUT",
                        url: "{{url('manager/payment/type')}}/" + paymentTypeID,
                        data: {
                            'paymentTypeName': paymentTypeName.val(),
                            '_token': token
                        },
                ...
                Swal.fire({
                    ...
                    if(t.value){
                        $.ajax({
                            ...
                            type: "DELETE",
                            url: "{{url('manager/payment/type/')}}/" + id,
                            data: {
                                '_token': token
                            },
                            contentType: "application/json",
            ...
            $(document).on('click', '.btn-status', function () {
                ...
                $.ajax({
                    type: "post",
                    url: "{{url('manager/payment/type/status')}}",
                    data: {
                        'status': status,
                        'id': id,
                        '_token': token
