    ...
    <script !src="">
        ...
        $(document).ready(function(){
            ...
            $(document).on("click", ".btn-edit", function () {
                var id = $(this).val();
                $.ajax({
                    url: "{{url('manager/courier')}}/" + id + "/edit",
                    headers: {
                        'X-CSRF-TOKEN': token
                    },
            ...
            $(document).on("click", "#submit", function () {
                ...
                if (type === 'Update') {
                    $.ajax({
                        type: "PUT",
                        url: "{{url('manager/courier')}}/" + courierID,
                        data: {
                            'courierName': courierName.val(),
                            'hasCity': hasCity,
                            'hasZone': hasZone,
            ...
            $(document).on('click', '.btn-status', function () {
                ...
                $.ajax({
                    type: "post",
                    url: "{{url('manager/courier/status')}}",
                    data: {
                        'status': status,
                        'id': id,
                        '_token': token
