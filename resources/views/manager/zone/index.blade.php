        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <h4 class="page-title mt-0 d-inline">Total <span class="total">0</span> Zone </h4>
                        </div>
                        <div class="col-md-6">
                            <div class="text-md-right">
                                <button type="button" class="btn btn-blue btn-add btn-xs waves-effect waves-light float-right"><i class="mdi mdi-plus-circle mr-1"></i> Add New Zone</button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="cityID" id="cityID" class="form-control"  style="width: 100%" ></select>
                    </div>
                    <div class="form-group">
                        <label for="zoneName">Zone name</label>
                        <input class="form-control" id="zoneName" name="zoneName">
                    </div>
                </div>
        ...
        $(document).ready(function(){
            var table = $("#storeTable").DataTable({
                ...
                language:{
                    ...
                    "emptyTable": "No Zone available in table"
                },
            ...
            $(document).on("click", ".btn-edit", function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $("#courierID").empty().append('<option value="' + data['data']['courier_id'] + '"  >' + data['data']['courierName'] + '</option>');
                        $("#cityID").empty().append('<option value="' + data['data']['city_id'] + '"  >' + data['data']['cityName'] + '</option>');
            ...
            $(document).on("click", "#submit", function () {
                ...
                if (!zoneName.val()) {
                    toastr.error('Zone Name should not empty !');
                    return;
                }
                // Add Data
                if (type === 'Save') {
