...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6 col-xl-2">
            <a href="{{ url('manager/order/status/Delivered')}}">
        ...
        <div class="col-md-6 col-xl-2">
            <a href="{{ url('manager/order/status/Customer On Hold')}}">
                <div class="widget-rounded-circle card-box order pt-1 pb-1">
                    <div class="row">
                        <div class="col-12">
                            <div class="float-left">
        ...
        <div class="col-md-6 col-xl-2">
            <a href="{{ url('manager/order/status/Customer Confirm')}}">
                <div class="widget-rounded-circle card-box order pt-1 pb-1">
                    <div class="row">
                        <div class="col-12">
                            <div class="float-left">
        ...
        <div class="col-md-6 col-xl-2">
            <a href="{{ url('manager/order/status/Request to Return')}}">
                <div class="widget-rounded-circle card-box order pt-1 pb-1">
                    <div class="row">
                        <div class="col-12">
                            <div class="float-left">
        ...
        <div class="col-md-6 col-xl-2">
            <a href="{{ url('manager/order/status/Paid')}}">
                <div class="widget-rounded-circle card-box order pt-1 pb-1">
                    <div class="row">
                        <div class="col-12">
                            <div class="float-left">
        ...
        <div class="col-md-6 col-xl-1">
            <a href="{{ url('manager/order/status/Return')}}">
                <div class="widget-rounded-circle card-box order pt-1 pb-1">
                    <div class="row">
                        <div class="col-12">
                            <div class="float-left">
        ...
        <div class="col-md-6 col-xl-1">
            <a href="{{ url('manager/order/status/Lost')}}">
                <div class="widget-rounded-circle card-box order pt-1 pb-1">
                    <div class="row">
                        <div class="col-12">
                            <div class="float-left">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-8">
                            <div class="text-md-right">
                                <button type="button"
                                        class="btn btn-warning btn-sync btn-xs waves-effect waves-light ml-2 float-right">
                                    <i class="fas fa-sync fa-spin mr-1"></i> Sync Order
                                </button>
                                <div class="btn-group dropdown ml-2 float-right">
                                    <a href="javascript: void(0);"
                                       class="table-action-btn dropdown-toggle arrow-none btn bg-info btn-xs"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item btn-change-status" data-status="Paid" href="#">Paid</a>
                                        <a class="dropdown-item btn-change-status" data-status="Return"
                                           href="#">Return</a>
                                        <a class="dropdown-item btn-change-status" data-status="Lost" href="#">Lost</a>
                                    </div>
                                </div>

                                <div class="btn-group dropdown ml-2 float-right">
                                    <a href="javascript: void(0);"
                                       class="table-action-btn dropdown-toggle arrow-none btn bg-success btn-xs"
                                       data-toggle="dropdown" aria-expanded="false"><i
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        @foreach($users as $user)
                                            <a class="dropdown-item btn-assign-user" data-id="{{$user->id}}"
                                               href="#">{{$user->name}}</a>
                                        @endforeach
                                    </div>
                                </div>
                                <button type="button"
                                        class="btn btn-danger btn-all-delete btn-xs waves-effect waves-light ml-2 float-right">
                                    <i
...
@push('js')
            ...
            var table = $("#orderTable").DataTable({
                ...
                columnDefs: [
                 ...
                 columns: [
                    ...
                    {data: 'invoice',width: "10%",searchable:false},
                    {data: 'customerInfo',width: "5%",searchable:false},
                    {data: "products",width: "15%",searchable:false},
                    {data: "subTotal",width: "5%",searchable:false},
                    ...
                    {data: 'memo',className:'memo',width: "10%",searchable:false},
 ...
 $(".datepicker").flatpickr();
        ...
        $(".courierID").select2({
            ...
            $(document).on("focusout", "input#memo", function(e) {
                const orderID = $(this).parent("td").parent("tr");
                const memo = $(this).val();
                const id = orderID[0].id;
                    jQuery.ajax({
                        type: "get",
                        url: "{{url('manager/order/memoUpdate')}}",
