										...
										<div id="side-sortables" class="accordion-container">
											<ul class="outer-border">
												...
												<li class="control-section accordion-section  add-page" id="add-page">
													<h3 class="accordion-section-title hndle" tabindex="0"> Category Link <span class="screen-reader-text">Press return or enter to expand</span></h3>
													<div class="accordion-section-content ">
														<div class="inside">
															<div class="customlinkdiv" id="customlinkdiv">
																<div>
																	@foreach($categories as $category)
																		<div class="custom-control custom-checkbox">
																			<input type="checkbox" class="custom-control-input" name="category" value="{{ $category->categoryName }}" data-link="{{ url('category/'.$category->categorySlug) }}"  id="customCheck{{ $category->id }}">
																			<label class="custom-control-label" for="customCheck{{ $category->id }}">{{ $category->categoryName }}</label>
																		</div>
																	@endforeach
																	<br>
																</div>
																...
																<p class="button-controls">
																	...
																	<a  href="#" onclick="addcustommenucategory()"  class="button-secondary submit-add-to-menu right"  >Add menu item</a>
																	<span class="spinner" id="spincustomu"></span>
																</p>
												...
												<li class="control-section accordion-section  add-page" id="add-page">
													<h3 class="accordion-section-title hndle" tabindex="0"> Page Link <span class="screen-reader-text">Press return or enter to expand</span></h3>
													<div class="accordion-section-content ">
														<div class="inside">
															<div class="customlinkdiv" id="customlinkdiv">
																<div>
																	@foreach($pages as $page)
																		<div class="custom-control custom-checkbox">
																			<input type="checkbox" class="custom-control-input" name="page" value="{{ $page->pageTitle }}" data-link="{{ url('page/'.$page->pageSlug) }}"  id="page{{ $page->id }}">
																			<label class="custom-control-label" for="page{{ $page->id }}">{{ $page->pageTitle }}</label>
																		</div>
																	@endforeach
																	<br>
																</div>
																...
																<p class="button-controls">
																	...
																	<a  href="#" onclick="addcustommenupage()"  class="button-secondary submit-add-to-menu right"  >Add menu item</a>
																	<span class="spinner" id="spincustomu"></span>
																</p>
