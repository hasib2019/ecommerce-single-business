...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-xl-2">
            <a href="{{ url('admin/order/status/Customer On Hold')}}">
                <div class="widget-rounded-circle card-box order pt-1 pb-1">
                    <div class="row">
                        <div class="col-12">
                            <div class="float-left">
        ...
        <div class="col-md-6 col-xl-2">
            <a href="{{ url('admin/order/status/Request to Return')}}">
                <div class="widget-rounded-circle card-box order pt-1 pb-1">
                    <div class="row">
                        <div class="col-12">
                            <div class="float-left">
...
$(".datepicker").flatpickr();
        ...
        $(".courierID").select2({
            ...
            $(document).on("click", "table td.memo", function(event) {
                if (+$(this).html() >= 0 || $(this).html() === "") {
                    var memo = $(this).html();
                    var html = '<input type="text" value="' + memo + '" id="memo">';
                    $(this).html(html);
                }
            });
            $(document).on("focusout", "input#memo", function(e) {
                ...
                const id = orderID[0].id;
                    jQuery.ajax({
                        type: "get",
                        url: "{{url('admin/order/memoUpdate')}}",
