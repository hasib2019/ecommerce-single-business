        ...
        <div class="tile-body">
            <div class="form-group">
                ...
                <select name="stripe_payment_method" id="stripe_payment_method" class="form-control">
                    <option value="1" {{ (Settings::get('stripe_payment_method')) == 1 ? 'selected' : '' }}>Enabled</option>
                    <option value="0" {{ (Settings::get('stripe_payment_method')) == 0 ? 'selected' : '' }}>Disabled</option>
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group pb-2">
                ...
                <input
                    ...
                    value="{{ Settings::get('stripe_secret_key') }}"
                />
            </div>
            <hr>
            <div class="form-group pt-2">
                ...
                <select name="paypal_payment_method" id="paypal_payment_method" class="form-control">
                    <option value="1" {{ (Settings::get('paypal_payment_method')) == 1 ? 'selected' : '' }}>Enabled</option>
                    <option value="0" {{ (Settings::get('paypal_payment_method')) == 0 ? 'selected' : '' }}>Disabled</option>
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    value="{{ Settings::get('paypal_secret_id') }}"
                />
            </div>
        </div>
