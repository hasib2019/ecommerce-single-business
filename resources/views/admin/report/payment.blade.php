    ...
    <script !src="">
        ...
        $(document).ready(function () {
            ...
            var table = $("#reportTable").DataTable({
                type: "get",
                ajax: {
                    url: "{{url('admin/report/getPayment')}}",
                    data: {
                ...
                buttons: {
                    buttons: [{
                        ...
                        customize: function (win) {
                            ...
                            $(win.document.body).find('h1').after('<p style="text-align: center"><?php echo date("l, Y-m-d"); ?></p>');
            ...
            $("#paymentTypeID").select2({
                ...
                ajax: {
                    url:'{{url('admin/report/paymentType')}}',
                    processResults: function (data) {
                        var data = $.parseJSON(data);
                        return {
                            results: data
            ...
            $("#paymentID").select2({
                ...
                ajax: {
                    url:'{{url('admin/report/paymentID')}}',
                    processResults: function (data) {
                        var data = $.parseJSON(data);
                        return {
                            results: data
