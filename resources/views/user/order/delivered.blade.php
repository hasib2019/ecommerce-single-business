...
@section('content')
    <div class="row">
        ...
        <div class="col-md-6 col-xl-2">
            <a href="{{ url('user/order/status/Customer On Hold')}}">
                <div class="widget-rounded-circle card-box order pt-1 pb-1">
                    <div class="row">
                        <div class="col-12">
                            <div class="float-left">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", "table td.memo", function(event) {
                const status = $('#orderTable').attr('data-status');
                console.log(status)
                if(status !=='Paid' && status !=='Return' && status !=='Lost'){
                    if (+$(this).html() >= 0 || $(this).html() === "") {
                        var memo = $(this).html();
                        var html = '<input type="text" class="form-control" value="' + memo + '" id="memo">';
                        $(this).html(html);
                    }
                }
            });
